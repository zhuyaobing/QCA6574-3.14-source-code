...
EXTRA_OEMAKE += "CONFGI_ARM_MDMFERMIUM=n CONFIG_WLAN_FEATURE_SAE=y CONFIG_LINUX_QCMBR=y WLAN_OPEN_SOURCE=1 CONFIG_NON_QC_PLATFORM=y CONFIG_CLD_HL_SDIO_CORE=y"
